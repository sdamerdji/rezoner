...
# bluesky dataset.
sf_history <- st_read('./Desktop/rezoner/geobluesky.geojson')
...
final <- st_sf(final)
#st_write(final, "~/Desktop/rezoner/four_rezonings.geojson")
final <- st_transform(final[1:nrow(final),], crs = 4326)
st_write_feather(final, "~/Desktop/rezoner/rezoner/four_rezonings.feather")
#df <- st_read_feather("~/Desktop/rezoner/rezoner/four_rezonings.feather")
